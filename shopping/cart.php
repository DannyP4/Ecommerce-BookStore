                      ...
                      <?php if(count($allProducts) > 0) : ?>
                        <?php foreach($allProducts as $product) : ?>
                          <tr class="mb-4">
                            ...
                            <td><button value="<?php echo $product->id; ?>" class="btn btn-danger text-white btn-delete"><i class="fas fa-trash-alt btn-delete"></i> </button></td>
                          </tr>
                        <?php endforeach; ?>
                      <?php else : ?>
                        <div class="alert alert-danger bg-danger text-white">
                          <h4 class="alert-heading">No products in cart!</h4>
